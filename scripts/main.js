...
// Function to give 3 hikes and their data to firestore "hikes"
function writeHikes() {
  ...
  hikesRef.add({
    code: "COQ01",
    name: "Sawblade Falls Trail", //replace with your own city?
    city: "Coquitlam",
    province: "BC",
    level: "moderate",
    details: "An adventurous hike to the waterfall",
    length: 8, //number value
  ...
  hikesRef.add({
    ...
    hike_time: 90, //number value
    lat: 49.3399431028579,
    lng: -122.85908496766939,
    last_updated: firebase.firestore.Timestamp.fromDate(new Date("March 16, 2024")),
  });
  hikesRef.add({
    code: "NV01",
